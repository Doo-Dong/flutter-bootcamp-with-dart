...
class StoryBrain {
  ...
  void nextStory([int addNum = 0]) {
    if (_storyNumber == 0 && addNum == 2) {
      _storyNumber = 1;
    } else if (_storyNumber == 0 && addNum == 1) {
      _storyNumber = 2;
    } else if (_storyNumber == 1 || (_storyNumber == 2 && addNum == 2)) {
      _storyNumber += addNum;
    } else if (_storyNumber == 2 && addNum == 1) {
      _storyNumber = 5;
